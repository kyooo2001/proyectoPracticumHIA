...
<x-adminlte-small-box title="Consultorios Médicos" text="Listado de consultorios médicos." icon="fas fa-h-square"/>
@stop
...
<div class="card">
  <div class="card-body">
    <div class="text-right">
      <a href="{{url('consultorios/create')}}" class="btn btn-primary btn-lg active" data-mdb-ripple-init role="button" aria-pressed="true">
        Crear nuevo consultorio médico.
      </a>
    </div>
    <br>
