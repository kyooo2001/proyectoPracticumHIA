        ...
        <div class="card">
            <div class="card-body">
                <div class="text-right">
                    <a href="{{ url('facturas/create') }}" class="btn btn-primary btn-lg active" data-mdb-ripple-init
            ...
            <x-adminlte-datatable id="table16" :heads="$heads" head-theme="light" :config="$config" striped hoverable
                bordered compressed>
                ...
                @if (Auth::check() && Auth::user()->hasRole('secretaria')) {{-- Verifica que el usuario está autenticado y tiene relación con secretaria --}}
                    @foreach ($facturas as $factura)
                        <tr>
                            ...
                            <td><a href= "{{ route('facturas.edit', $factura) }}"
                                    class= "btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                                    <i class="fa fa-lg fa-fw fa-pen"></i>
                                </a>
                                {{-- DESTROY data  --}}

                                <form style="display: inline" action="{{ route('facturas.destroy', $factura) }}"
                                ...
                                <a href="{{ route('facturas.print_factura', $factura->id) }}"
