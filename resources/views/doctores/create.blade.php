...
<x-adminlte-small-box title="Doctores" text="Registro de nuevo doctor." icon="fas fa-h-square"/>
@stop
...
<form action="{{route('doctores.store')}}" method="post">
    ...
    <x-adminlte-card theme="lime" theme-mode="outline">
            ...
            {{-- With prepend slot --}}
        <x-adminlte-input name="nombres" label="Nombres" placeholder="Nombre consultorio médico" label-class="text-lightblue" value="{{ old('nombres') }}">
        ...
        <x-adminlte-input name="apellidos" label="Apellidos" placeholder="Nombre consultorio médico" label-class="text-lightblue" value="{{ old('apellidos') }}">
            <x-slot name="prependSlot">
                <div class="input-group-text">
                    <i class="fas fa-user-md text-lightblue"></i>
                </div>
        ...
        <x-adminlte-input name="celular" label="Número celular" placeholder="12345678" label-class="text-lightblue" value="{{ old('celular') }}">
            <x-slot name="prependSlot">
                <div class="input-group-text">
        ...
        <x-adminlte-input name="licencia_medica" label="Licencia Médica " placeholder="Número de licencia médica" label-class="text-lightblue" value="{{ old('licencia_medica') }}">
            <x-slot name="prependSlot">
                <div class="input-group-text">
        ...
        <x-adminlte-input name="especialidad" label="Especilidad" placeholder="Especialidad médica" label-class="text-lightblue" value="{{ old('especialidad') }}">
            <x-slot name="prependSlot">
                <div class="input-group-text">
