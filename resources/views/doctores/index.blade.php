        ...
        <div class="card">
            <div class="card-body">
                <div class="text-right">
                    <a href="{{ url('doctores/create') }}" class="btn btn-primary btn-lg active" data-mdb-ripple-init
            ...
            <x-adminlte-datatable id="table1" :heads="$heads" head-theme="light" :config="$config" striped hoverable
                ...
                @foreach ($doctores as $doctors)
                    <tr>
                        ...
                        <td>
                            @hasanyrole('administrator')
                                <a href= "{{ route('doctores.edit', $doctors) }}"
                            ...
                            @hasanyrole('administrator')
                                <form style="display: inline" action="{{ route('doctores.destroy', $doctors) }}" method="POST"
                                    class="formEliminar">
                                    @csrf
                                    @method('DELETE')
                                    {!! $btnDelete !!}
                            ...
                            @endhasanyrole
                            <a href= "{{ route('doctores.show', $doctors) }}"
