    ...
    <form action="{{ route('historiales.store') }}" method="post">
        ...
        <x-adminlte-card theme="navy" theme-mode="outline">
            ...
            <div class="form-group">
                <x-adminlte-input type="date" name="fecha_visita" id="fecha_visita" label="Fecha de diagnóstico"
                    placeholder="Fecha de diagnóstico" label-class="text-lightblue" value="{{ 'fecha_visita' }}">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
            ...
            <x-adminlte-text-editor name="detalle" label="Detalles médicos del paciente." label-class="text-lightblue"
                igroup-size="sm" placeholder="Describa los diagnosticos realizados..." :config="$config" />
