...
<form action="{{route('secretarias.update',$secretaria->id)}}" method="post">
    ...
    <x-adminlte-card theme="lime" theme-mode="outline">
            ...
            {{-- With prepend slot --}}
        <x-adminlte-input name="nombres" label="Nombres" label-class="text-lightblue" value="{{$secretaria->nombres }}">{{$secretaria->nombres}}
        ...
        <x-adminlte-input name="apellidos" label="Apellidos" label-class="text-lightblue" value="{{$secretaria->apellidos }}">{{$secretaria->apellidos}}
            <x-slot name="prependSlot">
                <div class="input-group-text">
                    <i class="fas fa-user text-lightblue"></i>
                </div>
        ...
        <x-adminlte-input name="email" label="Email" label-class="text-lightblue" type="email" value="{{$secretaria->user->email}}">{{$secretaria->user->email}}
            <x-slot name="prependSlot">
                <div class="input-group-text">
