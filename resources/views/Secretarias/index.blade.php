...
@section('content')
    ...
    {{-- Setup data for datatables list secretarias --}}
    <div class="card">
        <div class="card-body">
            <div class="text-right">
                <a href="{{ url('secretarias/create') }}" class="btn btn-primary btn-lg active" data-mdb-ripple-init
            ...
            {{-- Trae la informacion de la tabla secretaria y user --}}
            <x-adminlte-datatable id="table1" :heads="$heads" head-theme="light" :config="$config" striped hoverable
                bordered compressed>
                ...
                @foreach ($secretaria as $secretaria)
                    <tr>
                        ...
                        {{-- Botton edit data  --}}
                        <td><a href= "{{ route('secretarias.edit', $secretaria) }}"
                                class= "btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                                <i class="fa fa-lg fa-fw fa-pen"></i>
                            </a>
                            {{-- DESTROY data  --}}

                            <form style="display: inline" action="{{ route('secretarias.destroy', $secretaria) }}"
